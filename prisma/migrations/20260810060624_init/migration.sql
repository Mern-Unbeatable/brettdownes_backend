...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('STRIPE', 'PICKUP');
...
CREATE TABLE "Product" (
    ...
    "form" TEXT NOT NULL DEFAULT 'Lyophilized',
...
CREATE TABLE "Variant" (
    ...
    "weightOz" DOUBLE PRECISION NOT NULL DEFAULT 2,
    "lengthIn" DOUBLE PRECISION NOT NULL DEFAULT 6,
    "widthIn" DOUBLE PRECISION NOT NULL DEFAULT 4,
    "heightIn" DOUBLE PRECISION NOT NULL DEFAULT 2,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "sortOrder" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
